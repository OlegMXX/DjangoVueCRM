        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-4">
                <div class="box">
                    ...
                    <p>Max 5 clients</p>
                    <p>Max 5 leads</p>
                    <button @click="subscribe('free')" class="button is-primary mt-4">Subscribe</button>
            ...
            <div class="column is-4">
                <div class="box">
                    ...
                    <button @click="subscribe('smallteam')" class="button is-primary mt-4">Subscribe</button>
                </div>
            </div>
            ...
            <div class="column is-4">
                <div class="box">
                    ...
                    <button @click="subscribe('bigteam')" class="button is-primary mt-4">Subscribe</button>
